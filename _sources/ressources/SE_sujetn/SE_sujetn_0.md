...
<div class="card-container">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <img src="../../_static/images/SE/wolver_inprogress.png" alt="h_sens_phy" class="img-responsive">
      <p> objectifs de l'item </p>
      <p class="card-footer-link">
        <a href="../SE_sujetn/SE_sujetn_1.html" class="card-link">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p> objectifs de l'item  </p>
      <p class="card-footer-link">
        <a href="../SE_sujetn/SE_sujetn_2.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p> objectifs de l'item </p>
      <p class="card-footer-link">
        <a href="../SE_sujetn/SE_sujetn_n.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 30px; position: relative;">
  ...
  <a href="../SE__index.html" style="display: inline-block; padding: 6px 30px; background-color: #bec9dcff; color: white; text-decoration: none; border-radius: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: all 0.3s; text-align: center; position: absolute; left: 50%; transform: translateX(-50%);">
    🔄 Retour aux thématiques <br> 'systèmes électriques'
  </a>

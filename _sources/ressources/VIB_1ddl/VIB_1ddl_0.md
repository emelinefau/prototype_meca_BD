...
# VIB 1ddl
objectifs généraux du sujet : retrouver très facilement le comportement d'un système masse/ressort amortisseur. Analogies pour les poutres . 
...
<div class="card-container">
  ...
  <div class="card">
    <div class="card-header" style="text-align: center;">
      1ddl.2 : pour les poutres
    </div>
    <div class="card-body">
      <img src="../../_static/images/VIB/wolver_inprogress.png" alt="h_sens_phy" class="img-responsive">
      <p> objectifs de l'item  </p>
      <p class="card-footer-link">
        <a href="../VIB_1ddl/VIB_1ddl_2.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p> objectifs de l'item </p>
      <p class="card-footer-link">
        <a href="../VIB_1ddl/VIB_1ddl_n.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>

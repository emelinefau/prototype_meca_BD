...
# Sujets amorcés en systèmes asservis
 * déphasage
 * marges (phase et gain) -> le fameux point critique
 * déduire FTBF de la FTBO
 * réponse temporelle à une sollicitation oscillante
 * 

# Vos suggestions/besoins en systèmes asservis
 * types de diag (Bode, Nyquist, Black)
 * exemple asserv en V (maintenir V avec pente)
 * 
 * 

...
*Objectif de cette fiche : retrouver avec les mains les expressions des moments V=RW et C=RF, avec le bon vecteur directeur.*

![Page 1 droite](../../ressources/img/MG_Torseurs/page_4_gauche.png)
...
![Page 1 droite](../../ressources/img/MG_Torseurs/page_4_droite.png)
<p style="color: #0066cc; font-style: italic; margin: 15px 0; font-size: 13px;text-align: right;">
   Surlignez ce texte pour commenter la page     👆       - 
</p>

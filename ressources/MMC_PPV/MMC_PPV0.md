...
# MMC Principe des puissance virtuelle
...
<div class="card-container">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <img src="../../_static/images/MMC/PPV/wolver_inprogress.png" alt="h_sens_phy" class="img-responsive">
      <p> objectifs de l'item </p>
      <p class="card-footer-link">
        <a href="../MMC_PPV/MMC_PPV1.html" class="card-link">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p> objectifs de l'item  </p>
      <p class="card-footer-link">
        <a href="../MMC_PPV/MMC_PPV2.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p> objectifs de l'item </p>
      <p class="card-footer-link">
        <a href="../MMC_PPV/MMC_PPVn.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>

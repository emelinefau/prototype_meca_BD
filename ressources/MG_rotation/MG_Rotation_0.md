...
# MG Rotations
Retrouver sans difficulté les termes d'une matrice de rotation et leur donner un sens physique
...
<div class="card-container">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-footer-link">
        <a href="../MG_rotation/MG_Rotation_1.html" class="card-link">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p> objectifs de l'item </p>
      <p class="card-footer-link">
        <a href="../MG_rotation/MG_Rotation_2.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p> objectifs de l'item </p>
      <p class="card-footer-link">
        <a href="../MG_rotation/MG_Rotation_n.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>

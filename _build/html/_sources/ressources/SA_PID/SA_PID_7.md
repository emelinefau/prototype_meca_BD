...
# pid.7 : causalité 
*Objectif de cette fiche : comprendre les limites physiques (la vraie vie) d'un modèle analytique qui s'appuie sur v(t). Comprendre aussi pourquoi dans une fonction de transfert le polynome du dénominateur est toujours d'ordre plus grand que le numérateur.*

![Page 1 droite](../../ressources/img/SA_PID_p1/page_12_gauche.png)
...
![Page 1 droite](../../ressources/img/SA_PID_p1/page_12_droite.png)
<p style="color: #0066cc; font-style: italic; margin: 15px 0; font-size: 13px;text-align: right;">
   Surlignez ce texte pour commenter la page     👆       - 
</p>
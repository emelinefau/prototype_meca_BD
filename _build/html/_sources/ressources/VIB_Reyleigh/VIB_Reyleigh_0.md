...
# VIB Reyleigh
objectifs généraux du sujet : un transfet d'énergie entre du mouvement et du stockage. L'écrire dans le 'bon' sens c'est se souvenir que le W2 sort avec la vitesse au carré (donc Ec)
...
<div class="card-container">
  ...
  <div class="card">
    <div class="card-header" style="text-align: center;">
      rey.2 : écrire dans le bon sens
    </div>
    <div class="card-body">
      <img src="../../_static/images/VIB/wolver_inprogress.png" alt="h_sens_phy" class="img-responsive">
      <p> objectifs de l'item  </p>
      <p class="card-footer-link">
        <a href="../VIB_Reyleigh/VIB_Reyleigh_2.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p> objectifs de l'item </p>
      <p class="card-footer-link">
        <a href="../VIB_Reyleigh/VIB_Reyleigh_n.html" class="card-link">
          Voir la fiche <i class="fas fa-arrow-right"></i>
        </a>
      </p>
    </div>
